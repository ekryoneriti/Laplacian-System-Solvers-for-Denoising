///*
// * deterministic_sparse_matlab_api.cpp
// *
...
/* check for proper number of arguments */
    if(nrhs!=5) {
        mexErrMsgIdAndTxt("deterministic_sparse_matlab_api:nrhs","Five inputs required.");
    }
    if(nlhs!=6) {
        mexErrMsgIdAndTxt("deterministic_sparse_matlab_api:nlhs","Six outputs required.");
    }
//declare variables
...
// run deterministic cholesky
    ...
    deterministic_cholesky(A, L, D);
    auto end = std::chrono::steady_clock::now();
    std::cout << "Elapsed time in milliseconds deterministic: " 
